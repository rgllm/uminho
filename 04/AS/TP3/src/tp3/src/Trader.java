...
public class Trader implements Serializable{
    ...
    public void registarUtilizador (User u){
    ...
    public void addToWatchList(String company) throws IOException{
       String loggedEmail = loggedUser.getEmail();
        loggedUser.getWatchList().add(company);
        userDAO.addToWatchlist(loggedEmail, company);
    }
    
    public void addCFD(CFD invest) throws SaldoException, IOException{
