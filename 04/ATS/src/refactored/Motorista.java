...
public class Motorista extends Ator implements Serializable
{
    ...
    public String toString(){
        ...
        s.append(super.toString()).append("\n" + "Grau de cumprimento de horário: ").append(this.grau).append("\n" + "Classificação do motorista: ").append(this.classificacao)
				.append("\n" + "Número de Kms realizados na UMeR até ao momento: ").append(String.format("%.2f",this.kmsTotais)).append("\n" + "O motorista encontra-se em horário de trabalho: ").append(this.disponivel).append("\n");
        if(taxi != null) {
